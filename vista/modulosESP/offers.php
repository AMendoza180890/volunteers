     ...
     <div class="container">
         ...
         <div class="row">
             <div class="col-xl-4 col-md-6 col-lg-4">
                 <div class="single_department">
                     <div class="department_thumb">
                         <img src="vista/img/department/1.png" alt="">
                     </div>
             ...
             <div class="col-xl-4 col-md-6 col-lg-4">
                 <div class="single_department">
                     <div class="department_thumb">
                         <img src="vista/img/department/2.png" alt="">
                     </div>
                     <div class="department_content">
             ...
             <div class="col-xl-4 col-md-6 col-lg-4">
                 <div class="single_department">
                     <div class="department_thumb">
                         <img src="vista/img/department/3.png" alt="">
                     </div>
                     <div class="department_content">
             ...
             <div class="col-xl-4 col-md-6 col-lg-4">
                 <div class="single_department">
                     <div class="department_thumb">
                         <img src="vista/img/department/4.png" alt="">
                     </div>
                     <div class="department_content">
             ...
             <div class="col-xl-4 col-md-6 col-lg-4">
                 <div class="single_department">
                     <div class="department_thumb">
                         <img src="vista/img/department/5.png" alt="">
                     </div>
                     <div class="department_content">
             ...
             <div class="col-xl-4 col-md-6 col-lg-4">
                 <div class="single_department">
                     <div class="department_thumb">
                         <img src="vista/img/department/6.png" alt="">
                     </div>
                     <div class="department_content">
