        ...
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6">
                <div class="welcome_docmed_info">
                    ...
                    <ul>
                        <li> <i class="flaticon-right"></i> Carta de estudiante activo de la Universidad donde asiste o bien su título profesional.</li>
                    </ul>
                    <p>Si estás interesado en ser un pasante en Tesoros de Dios, por favor aplica abajo.</p>
