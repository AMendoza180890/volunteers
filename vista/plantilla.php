<?php
    //Header with link
    include_once 'modulos/encabezadoEtiqueta.php';

    //Body
    include_once 'modulos/header.php';
    include_once 'modulos/sliders.php';
    include_once 'modulos/services.php';
    include_once 'modulos/business.php';
    include_once 'modulos/servicio1.php';
    include_once 'modulos/servicio2.php';
